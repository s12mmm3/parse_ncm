...
async def _(
    ...
    parsed_content: Union[
        SongInfo, AlbumInfo, UserInfo, PlaylistInfo, ArtistInfo, MVInfo, None
    ] = None
    ...
    if parsed_content:
        ...
        try:
            ...
            elif isinstance(parsed_content, MVInfo):
                final_message = await MessageBuilder.build_mv_message(parsed_content)
            else:
                logger.warning(
